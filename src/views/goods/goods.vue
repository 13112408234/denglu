        ...
        <el-card>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    ...
                    <el-input placeholder="请输入内容" v-model="querInfo.query" clearable @clear="ProductListBox"
                        @input="inputHover">
                        <el-button slot="append" icon="el-icon-search" @click="ProductListBox">
                        </el-button>
                    </el-input>
                </el-col>
                <el-col :span="4">
            ...
            <el-table :data="tableData" style="width: 100%" border stripe class="tablecolumn">
                <!-- 第一列 -->
                ...
                <el-table-column prop="add_time" label="创建时间" width="140px" class="tablecolumn">
            ...
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                :current-page="querInfo.pagenum" :page-sizes="[8, 15, 20]" :page-size="querInfo.pagesize"
...
<script>
    ...
    export default {
        ...
        methods: {
            // 封装商品列表请求
            ProductListBox() {
                ProductList(this.querInfo.query, this.querInfo.pagenum, this.querInfo.pagesize).then((res) => {
